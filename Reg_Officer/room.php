    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <?php 
             ...
             $query = $con->query("SELECT * from prisoner JOIN address on address.address_id=prisoner.address_id where status='checkin' AND (room_name='not_assigned' or room_name='' ) ") or die(mysqli_error());
                ...
                <td><?php echo $fetch['fname']?></td>
                        ...
                        <!-- <td><?php echo ($fetch['region'])?></td>
                            ...
                            <td><center><a class = "btn btn-warning" href = "assign_room.php?prisoner_id=<?php echo $fetch['address_id']?>"><i class = "glyphicon glyphicon-menu-down"></i> assign room</a></center></td>       
                        </tr>
