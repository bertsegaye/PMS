            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">ReRegister temporary prisoners</h4> </div>
                    ...
                    <a href="" target="" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">Welcome to Assosa Correction House</a>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">temporary prisoners</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class = "alert alert-info">Prisoner / ReRegister temporary prisoners</div>
                 ...
                 $fetch = $query->fetch_array();
                    ...
                    <form method = "POST" action = "re_register_temporary_prisoners_query.php?prisoner_id=<?php echo $fetch['address_id']?>" enctype = "multipart/form-data">
                        ...
                        <div class = "form-group" style="width: 40%;float:left; margin-left:45px;">
                         ...
                         <select id="crime_type" name="crime_type" disabled class = "form-control" >
                            <option value = "">Choose an option</option>
                        ...
                        <div class = "form-group" style="width: 40%; float:left;">
                            <label>age </label>
                            <input type = "number" class = "form-control" value = "<?php echo $fetch['age']?>" name = "age" min="18" max="100" disabled  />
                        ...
                        <label for="prisoner type">prisoner type</label>
                         <select  name="ptype" required="" class = "form-control">
                              ...
                              <option value="temporary" <?php if ($fetch['prisoner_type']=="temporary"){echo "selected";}?>>temporary</option>
                            <option value="permanent" <?php if ($fetch['prisoner_type']=="permanent"){echo "selected";}?>>permanent</option>
                            </select>
                        </div>
                        ...
                        <div class = "form-group">
                            <button name = "reRegisterPrisoner" class = "btn btn-warning form-control" onclick="return confirmation ();"><i class = "fa fa-mail-reply "></i>   Back ToPrison</button>
                        </div>
                        <!--
                        <div class = "form-group">
...
<script type="text/javascript">
    ...
    {
        var x =confirm("you  back the temporary   Prisoner to correction house... Are you sure? ");
        if (x==true)
        {
