        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class = "alert alert-info">Prisoner/Modify Prisoner Information</div>
                 ...
                 $fetch = $query->fetch_array();
                        ?>
                            <br />
                   <div style="width: 50%;">
                    <form method = "POST" action = "edit_quiery_prisoner_info.php?prisoner_id=<?php echo $fetch['address_id']?>" enctype = "multipart/form-data">
                        <div class = "form-group">
                            <label>fname </label>
                            <input type = "text" class = "form-control" value = "<?php echo $fetch['fname']?>"  name = "fname" maxlength="20" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)"/>
                        </div>
                        <div class = "form-group">
                            <label>lname </label>
                            <input type = "text" class = "form-control" value = "<?php echo $fetch['lname']?>"  name = "lname" maxlength="20" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)"/>
                        </div>
                        ...
                        <div class = "form-group">
                         ...
                         <select id="crime_type" name="crime_type" class = "form-control">
                            ...
                            <option value="corruption" <?php if ($fetch['crime_type']=="corruption"){echo "selected";}?>>corruption</option>
                              ...
                              <option value="Receipt_of_Stolen_Goods" <?php if ($fetch['crime_type']=="Receipt_of_Stolen_Goods"){echo "selected";}?>>Receipt_of_Stolen_Goods</option>
                        ...
                        <div class = "form-group">
                            ...
                            <input type = "file"  id = "photo" name = "photo" disabled accept="image/gif, image/jpeg, image/png" />
                        </div>
                          ...
                          <div class = "form-group">
                            <label>woreda </label>
                            <input type = "text" class = "form-control" value = "<?php echo $fetch['woreda']?>" name = "woreda" maxlength="20"/>
                        </div>
                          ...
                          <div class = "form-group">
                            <label>zone </label>
                            <input type = "text" class = "form-control" value = "<?php echo $fetch['zone']?>" name = "zone" maxlength="20"/>
                        </div>


                          <div class = "form-group">
                            <label>kebele </label>
                            <input type = "text" class = "form-control" value = "<?php echo $fetch['kebele']?>" name = "kebele" maxlength="20"/>
                        </div>
