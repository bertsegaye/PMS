        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class = "alert alert-info">Prisoners / ReRegister checkout or transfered prisoners</div>
            ...
            <?php 
             ...
             $query = $con->query("SELECT * from prisoner  JOIN address on address.address_id=prisoner.address_id WHERE (status='CheckOut' OR status='transfered')") or die(mysqli_error());
                        ...
                        <td><?php echo ($fetch['release_date'])?></td>
                         ...
                         <td><?php echo ($fetch['region'])?></td>
                            ...
                            <td><center><a class = "btn btn-primary" href = "re_register_prisonerInfo.php?prisoner_id=<?php echo $fetch['address_id']?>"><i class='fa fa-mail-reply'></i>  Reregister</a> </center></td>       
