        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class = "alert alert-info">Room / Manage Rooms</div>
				...
				$f_p = $q_p->fetch_array();
                $q_pp = $con->query("SELECT COUNT(*) as totall FROM `prisoner` WHERE status='checkin'") or die(mysqli_error());
				$f_pp = $q_pp->fetch_array();
			
			            ?>
                       
                              <table class="table">
                              <a class = "btn btn-success" href = "register_room.php"><i class = "glyphicon glyphicon-plus"></i> add New Room</a>&ensp;
                                  <!--  
            ...
            <?php 
             ...
             $query = $con->query("SELECT * from room WHERE gender=('male' or 'female')") or die(mysqli_error());
                            ...
                            <?php $gen=$fetch['gender']?>
                             <td><?php echo $gen?></td>
                           <?php
                           $_SESSION['gender'] ="$gen";
                           ?>
                            <td><center><a class = "btn btn-warning" href = "edit_room.php?room_name=<?php echo $fetch['room_name']?>"><i class = "glyphicon glyphicon-edit"></i> Edit</a> <a class = "btn btn-danger" onclick = "confirmationDelete(this); return false;" href = "delete_room_query.php?room_name=<?php echo $fetch['room_name']?>"><i class = "glyphicon glyphicon-remove"></i> Delete</a></center></td>   
...
<script type = "text/javascript">
    function confirmationDelete(anchor){
        var conf = confirm("Are you sure you want to delete this room?");
        if(conf){
