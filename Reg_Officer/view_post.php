        ...
        <div class="container-fluid">
          <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title" style="text-transform: capitalize;">View Announcement</h4> </div>
          ...
          <?php 
           ...
           $query = $con->query("SELECT * from announcement order by id DESC") or die(mysqli_error());
              ...
              <?php
              $status=$fetch['ro_status'];
         if($status==1){
           $query="UPDATE anticorruption SET status = 0 WHERE a_id = '$_REQUEST[report]' " or die(mysqli_error());
           mysqli_query($con,$query);
                    ...
                    ?>
                      ...
                      <div class="col-md-6 col-sm-12" style="margin-top: 0rem;">
...
<footer class="footer text-center" style="width: 100%; display: block; margin: 0; "> 2023 &copy; Assosa Prison Managment System , All Rights Reserved</footer>
      </div>
      <!-- ============================================================== -->
      <!-- End Page Content -->
      <!-- ============================================================== -->
