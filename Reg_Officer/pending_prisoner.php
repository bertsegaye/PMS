        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class = "alert alert-info">Prisoners / Pending For Ketero Case</div>
				...
				$f_p = $q_p->fetch_array();
			            ...
			            ?>
                              ...
                              <table class="table">
                                    ...
                                    <a class = "btn btn-success disabled" href = "reserve.php"><span class = "badge"><?php echo $f_p['total']?></span> Pendings</a>&ensp;
            ...
            <?php 
             ...
             $query = $con->query("SELECT * from prisoner  JOIN address on address.address_id=prisoner.address_id WHERE status='InCourt'") or die(mysqli_error());
                        ...
                        <td><?php echo ($fetch['release_date'])?></td>
							...
							<td><center><a class = "btn btn-warning" href = "checkout_temporary_query.php?pid=<?php echo $fetch['pid']?>" onclick = "confirmationCheckin(); return false;"><i class = "glyphicon glyphicon-check"></i> Check Out</a>  <a class = "btn btn-primary" href = "re_register_temporary_prisoners.php?prisoner_id=<?php echo $fetch['address_id']?>"><i class='fa fa-mail-reply'></i>  BackToPrison</a> </center></td>
                        </tr>
...
<script type = "text/javascript">
	function confirmationCheckin(anchor){
		var conf = confirm("Are you sure you want to check out this prisoner freely from the correction house?");
		if(conf){
