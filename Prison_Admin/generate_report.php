...
<body class="fix-header">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class = "alert alert-info">Generate Report</div>
                ...
                if($sid=='total'){
             $query = $con->query("SELECT * from prisoner JOIN address on address.address_id=prisoner.address_id where status='checkin' ") or die(mysqli_error());
      ...
      <table id = "table" class = "table table-bordered">
            ...
            <?php 
             ...
             //$query = $con->query("SELECT * from users_info") or die(mysqli_error());
                        ...
                        <td><?php echo ($fetch['region'])?></td>
                            ...
                            <td><center><a class = "btn btn-warning" href = "indivi_prisoner_info.php?prisoner_id=<?php echo $fetch['address_id']?>"><i class = "glyphicon glyphicon-menu-down"></i> more</a></center></td>       
                        </tr>
        ...
        <?php if($sid=='maleActive'){
             $query = $con->query("SELECT * from prisoner JOIN address on address.address_id=prisoner.address_id where sex='male' AND status='checkin' ") or die(mysqli_error());
      ...
      <table id = "table" class = "table table-bordered">
            ...
            <?php 
             ...
             <?php if($sid=='femaleActive'){
             $query = $con->query("SELECT * from prisoner JOIN address on address.address_id=prisoner.address_id where sex='female' AND status='checkin' ") or die(mysqli_error());
            ...
            <?php 
             ...
             //$query = $con->query("SELECT * from users_info") or die(mysqli_error());
                ...
                <?php if($sid=='general'){
             //$query = $con->query("SELECT * from prisoner JOIN address on address.address_id=prisoner.address_id where sex='female' ") or die(mysqli_error());
                                           ?>
               <table id = "table" class = "table table-bordered">
            ...
            <?php 
             ...
             //$query = $con->query("SELECT * from users_info") or die(mysqli_error());
                        ...
                        $query2 = $con->query("SELECT COUNT(*) as total FROM `prisoner` WHERE age>='25' AND status='checkin'") or die(mysqli_error());
                        $fetch2 = $query2->fetch_array();
                            ?>
                            <tr>
                            <td> Total prisoners<?php echo $fetch['total']?></td>
