        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class = "alert alert-info">Prisoners / check out prisoners</div>
            ...
            <?php 
             ...
             $query = $con->query("SELECT * from prisoner  JOIN address on address.address_id=prisoner.address_id WHERE status='CheckOut' OR status='InCourt'") or die(mysqli_error());
...
<td><strong><?php if($fetch['status']=='CheckOut'){echo "<label style = 'color:#ff0000;'>".($fetch['status'])."</label>";}else if($fetch['status']=='InCourt'){echo "<label style = 'color:#00ff00;'>".($fetch['status'])."</label>";}?></strong></td>
