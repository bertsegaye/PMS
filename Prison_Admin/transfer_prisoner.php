            ...
            <div class="container-fluid">
                <!--<div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Transfer Prisoner</h4> </div>
                    ...
                    <a href="" target="" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">Welcome to Assosa Correction House</a>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Transfer Prisoner</li>
                        </ol>
                    </div>
                </div>-->
                <!-- /row -->
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class = "alert alert-info">Prisoners / Transfer Prisoners to another prisoner</div>
             ...
             $query = $con->query("SELECT * from prisoner JOIN address on address.address_id=prisoner.address_id where status='checkin' ") or die(mysqli_error());
                ...
                <td><?php echo $fetch['fname']?></td>
                        ...
                        <!-- <td><?php echo ($fetch['region'])?></td>
                            ...
                            <td><center><a class = "btn btn-warning" href = "transfer_prisoner_info.php?prisoner_id=<?php echo $fetch['address_id']?>"><i class = "fa fa-chevron-right"></i> Transfer</a></center></td>       
                        </tr>
