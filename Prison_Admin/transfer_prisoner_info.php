        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class = "alert alert-info">Prisoner / Transfer Prisoner Information</div>
                 ...
                 $fetch = $query->fetch_array();
                    ...
                    <form method = "POST" action = "transfer_prisoner_info_query.php?prisoner_id=<?php echo $fetch['address_id']?>" enctype = "multipart/form-data">
                        ...
                        <div class = "form-group" style="width: 40%;float:left; margin-left:45px;">
                         ...
                         <select id="crime_type" name="crime_type" required class = "form-control" disabled >
                            <option value = "">Choose an option</option>
                        ...
                        <div class = "form-group" style="width: 40%; float:left;">
                         ...
                         <select id="transfer_to" name="transfer_to" class = "form-control" required="required">
                            <option value = "" selected="true" disabled="disabled">Choose an option</option>
                            <option value="Gilgel/Beles">Gilgel/Beles</option>
                            <option value="Khamashi">Khamashi</option>
                            <option value="Manbuk">Manbuk</option>
                             </select>
                        </div>
                        ...
                        <div class = "form-group" style="width: 40%;float:left; margin-left:45px;">
                           ...
                           <input type="date" class = "form-control" id="entry_date" value = "<?php echo $fetch['entry_date']?>" name="entry_date" disabled  />
                       </div> 
                       <div class = "form-group" style="width: 40%;float:left;">
                            <label for="release_date">release_date</label>
                           <input type="date" class = "form-control" id="release_date" value = "<?php echo $fetch['release_date']?>" name="release_date" disabled  />
                       </div>
                        ...
                        <div class = "form-group">
                            <button name = "transfer_prisoner" class = "btn btn-warning form-control" onclick="return confirmation ();"><i class = "glyphicon glyphicon-edit"></i>transfer prisoner</button>
                        </div>
                        <!--
                        <div class = "form-group">
...
<script type="text/javascript">
    ...
    {
        var x =confirm("do you want to transfer prisoner ");
        if (x==true)
        {
