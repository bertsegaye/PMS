...
<body class="fix-header">
    ...
    <div id="wrapper">
        ...
        <!-- ============================================================== -->
        <nav class="navbar navbar-default navbar-static-top m-b-0" style="">
            <div class="navbar-header" style="background: #FFF1DC; height: 6rem;">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row" style="margin-top: 50px;">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class = "alert alert-info">Prisoners/ Display Active Prisoner Information</div>
