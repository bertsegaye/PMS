        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class = "alert alert-info">Prisoners / Prisoners Pending for checkout</div>
				...
				$f_pp = $q_pp->fetch_array();
			            ...
			            ?>
                              ...
                              <table class="table">
                                    ...
                                    <a class = "btn btn-info" href = "basic-table.php"><span class = "badge"><?php echo $f_pp['totall']?></span> Check In</a>&ensp;
            ...
            <?php 
             ...
             $query = $con->query("SELECT * from prisoner  JOIN address on address.address_id=prisoner.address_id WHERE release_date<='$today' AND status='checkin'") or die(mysqli_error());
                        ...
                        <td><?php echo ($fetch['release_date'])?></td>
                         ...
                         <td><?php echo ($fetch['region'])?></td>
							...
							<td><center><a class = "btn btn-warning" href = "checkout_query.php?pid=<?php echo $fetch['pid']?>" onclick = "confirmationCheckin(); return false;"><i class = "glyphicon glyphicon-check"></i> Check Out</a></center></td>
                        </tr>
