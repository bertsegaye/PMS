      ...
      <nav class="navbar navbar-default navbar-static-top m-b-0">
         <div class="navbar-header" style="background: #FFF1DC; ">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right" style="height: 0px;">
                    ...
                    <li class = "dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src = "../upload/image//<?php echo ($photo_session)?>" alt="user-img" width="50" class="img-circle"><?php echo $login_session;?></a>
      ...
      <div id="page-wrapper">
        <div class="container-fluid">
          ...
          <?php 
           ...
           $query = $con->query("SELECT * from announcement ") or die(mysqli_error());
                          ...
                          <td><center><a class = "btn btn-warning" href = "read_post.php?post=<?php echo $fetch['id']?>"><i class = "fa fa-eye"></i> view</a> <a class = "btn btn-danger" onclick = "confirmationDelete(this); return false;" href = "delete_post.php?id=<?php echo $fetch['id']?>"><i class = "glyphicon glyphicon-remove"></i> Delete</a></center></td>       
