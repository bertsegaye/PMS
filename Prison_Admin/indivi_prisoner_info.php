        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class = "alert alert-info">Prisoner/Display Prisoner Information</div>
                 ...
                 $fetch = $query->fetch_array();
                    ...
                    <form method = "POST" action = "edit_quiery_prisoner_info.php?prisoner_id=<?php echo $fetch['address_id']?>" enctype = "multipart/form-data">
                        ...
                        <div class = "form-group" style="width: 40%;float:left; margin-left:45px;">
                         ...
                         <select id="crime_type" name="crime_type" class = "form-control" disabled = "disabled">
                            <option value = "">Choose an option</option>
                        ...
                        <div class = "form-group" style="width: 40%; float:left;">
                            ...
                            ?>
                            <input type = "number" class = "form-control" value = "<?php echo $age ?>"  name = "age" disabled = "disabled"/>
                        
                        </div>
                        <div class = "form-group" style="width: 40%;float:left; margin-left:45px;">
                            <label for="tele">tele</label>
                           <input type="text" class = "form-control" id="tele" value = "<?php echo $fetch['phone']?>" name="tele" disabled = "disabled" />
                       </div>
                        ...
                        <div class = "form-group" style="width: 40%;float:left;">
                            <label>Region </label>
                             <select  name="region" class = "form-control" disabled = "disabled"> 
                                <option value = "">Choose an option</option>
                        ...
                        <div class = "form-group" style="width: 40%;float:left; margin-left:45px;">
                            <label>zone </label>
                            <input type = "text" class = "form-control" value = "<?php echo $fetch['zone']?>" name = "zone" disabled = "disabled"/>
                        </div>

                          <div class = "form-group" style="width: 40%;float:left;">
                            <label>woreda </label>
                            <input type = "text" class = "form-control" value = "<?php echo $fetch['woreda']?>" name = "woreda" disabled = "disabled" />
                        </div>

                          <div class = "form-group" style="width: 40%;float:left; margin-left:45px;">
                            <label>kebele </label>
                            <input type = "text" class = "form-control" value = "<?php echo $fetch['kebele']?>" name = "kebele" disabled = "disabled"/>
                        </div>
                        ...
                        <div class = "form-group" style="width: 50%;">
                            ...
                            <input type = "file" disabled = "disabled" id = "photo" name = "photo" />
                        </div>
