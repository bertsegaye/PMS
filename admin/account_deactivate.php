...
<html lang="en">
  ...
  <body class="fix-header">
      ...
      <div id="page-wrapper">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="white-box">
              <div class = "alert alert-info">Accounts/ Active Accounts</div>
            ...
            <?php 
             ...
             $query = $con->query("SELECT * from users_info JOIN users on users_info.serial_no=users.serial_no where users.status='1' ") or die(mysqli_error());
                         ...
                         <td><center><img src = "../upload/image//<?php echo ($fetch['photo'])?>" height = "50" width = "50"/></center></td>
                            ...
                            <td><center><a class = "btn btn-danger" onclick = "confirmationDeactive(this); return false;" href = "deactivate_account_query.php?id=<?php echo $fetch['serial_no']?>"><i class = "fa fa-ban"></i> Deactivate</a></center></td>       
                        </tr>
        ...
        <!-- /.container-fluid -->
        <footer class="footer text-center"> 2023 &copy; Assosa Prison Managment System For Assosa , All Rights Reserved</footer>
    ...
    function confirmationDeactive(anchor){
