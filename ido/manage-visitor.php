...
<head>
    ...
    <link href="plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.css" rel="stylesheet">
     ...
     <link href="css/icons/material-design-iconic-font/css/material-design-iconic-font.css" rel="stylesheet">
  ...
  ============================================================== -->
    ...
    <div id="wrapper">
       ...
       <div class="drop">
        ...
        <div id="page-wrapper" style="border-radius: 0.5rem;">
            ...
            <div class="container-fluid" >
                ...
                <!--/.row -->
                <div class="row" style=" margin-top: 50px; font-size:16px; padding: 0; ">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class = "alert alert-info" style="background-color: seagreen; font-size: 22px; color: black; border-radius: 0.5rem; width: 50%; margin-left: 300px;"><b>Manage Visitors Information</b></div>
                            <div class="table-responsive">
                              <table class="table">
                                    <a class = "btn btn-success" href = "add_visitor.php"><i class = "glyphicon glyphicon-plus"></i> New Visitor</a>
                                    <br />
                <br />
            ...
            <?php 
             ...
             $query = $con->query("SELECT * from visitor") or die("selecting from vistor query incorrect....");
                            ...
                            <td><?php echo ($fetch['tele'])?></td>
                            <td><center><img  src = "../upload/image//<?php echo ($fetch['photo'])?>" height = "50" width = "50"/></center></td>
                            <td><?php echo ($fetch['visitee'])?></td>

                            <td><center><a style="background-color:seagreen;" class = "btn btn-warning" href = "edit_visitor.php?visitor_id=<?php echo $fetch['vid']?>"><i style="color:white;" class = "glyphicon glyphicon-pencil"></i></a> <a style="background-color:red;"class = "btn btn-danger" onclick = "confirmationDelete(this); return false;" href = "delete_visitor.php?visitor_id=<?php echo $fetch['vid']?>"><i class = "glyphicon glyphicon-trash"></i></a></center></td>       
                        </tr>
